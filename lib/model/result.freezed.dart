...
mixin _$Result<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(ApiErrorResponse error) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(T value)? success,
    TResult? Function(ApiErrorResponse error)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class Failure<T> implements Result<T> {
  const factory Failure(final ApiErrorResponse error) = _$Failure<T>;
